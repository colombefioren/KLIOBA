...
class KliobaControllerTest {
    ...
    void setUp() {
        ...
        controller = new KliobaController(
                eventService,
    ...
    void historyByClub_withDefaultPagination_returnsHistoryView() {
        ...
        when(eventService.findAllByClubIdWithPaymentResolution(
                eq("c1"), isNull(), isNull(), isNull()))
                .thenReturn(List.of((Event) fee));

        String result = controller.historyByClub(
                "c1",
                model,
                0,
                50,
    ...
    void historyByClub_withCustomPagination_returnsPagedEvents() {
        ...
        var result = controller.historyByClub(
                "c1",
                model,
                1,
                2,
    ...
    void historyByClub_withDateFilter_returnsFilteredEvents() {
        ...
        var event1 = new MembershipFee("d1", payment, user, club, Instant.parse("2024-01-15T10:00:00Z"));
        var event2 = new MembershipFee("d2", payment, user, club, Instant.parse("2024-02-15T10:00:00Z"));
